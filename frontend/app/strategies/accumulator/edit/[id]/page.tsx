...
export default function EditAccumulatorStrategy() {
    ...
    const handleSave = async () => {
        ...
        if (selectedTeams.length < 2) {
            alert('Acumuladores precisam de pelo menos 2 equipas')
            return
        }
        ...
        <div className="min-h-screen bg-gray-900 p-8">
            <div className="max-w-4xl mx-auto">
                <div className="mb-8">
                    ...
                    <h1 className="text-3xl font-bold text-white mb-2">Editar Estratégia - Acumulador</h1>
                    <p className="text-gray-400">Modifica a tua estratégia de apostas múltiplas</p>
                </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-gray-800 p-6 rounded-lg">
                        <h2 className="text-xl font-bold text-white mb-4">Equipas (mínimo 2)</h2>
